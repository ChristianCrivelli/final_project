...
CREATE OR ALTER VIEW curated.mart_customer_ltv AS
SELECT
    u.user_key,
    u.id                                                AS user_id,
    u.gender,
...
CREATE OR ALTER VIEW curated.mart_customer_channel_behaviour AS
SELECT
    u.user_key,
    u.id                                                AS user_id,
...
CREATE OR ALTER VIEW curated.mart_customer_active_cards AS
SELECT
    u.user_key,
    u.id                                                AS user_id,
...
CREATE OR ALTER VIEW curated.mart_customer_suspicious_transactions AS -- statistical outlier + compromised card + error recorded
